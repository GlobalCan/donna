...
Write-Host "     - SLACK_BOT_TOKEN     (xoxb-... from api.slack.com/apps)"
Write-Host "     - SLACK_APP_TOKEN     (xapp-... with connections:write)"
Write-Host "     - SLACK_TEAM_ID       (T0... from your Slack URL)"
Write-Host "     - SLACK_ALLOWED_USER_ID  (U0... your Slack user ID)"
