    ...
    try:
        with transaction(conn):
            ...
            kn.insert_chunk(
                ...
                content="Huck reflects on civilization and Miss Watson",
                chunk_index=0, fingerprint="fp1",
                embedding=None, work_id=None,
                publication_date=None, source_type="book",
            )

        # This used to raise OperationalError; now returns the matching chunk.
        ...
        # Pure-punctuation queries return empty, not an error.
